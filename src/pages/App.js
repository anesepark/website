    ...
    <>
      ...
      <div className="tabs">
        ...
        <div className="tab-controls">
          ...
          <button onClick={() => clickTab(2)} className={clickArray[2] ? "active" : null}>resume</button>
          <button onClick={() => clickTab(3)} className={clickArray[3] ? "active" : null}>contactme</button>
        </div>
      </div>
    </>
  )
